...
class DetectionEvaluator:
    ...
    def evaluate_detections(self, params_str, csv_path):
        ...
        for detector_name in detector_names:
            ...
            print("Overall detection rate on SAEs: %f (%d/%d)" % (
                overall_detection_rate_saes / nb_saes, overall_detection_rate_saes, nb_saes))
        ...
        write_to_csv(to_csv, csv_path, fieldnames)
